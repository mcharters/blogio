//
//  BIODayViewController.m
//  blogio
//
//  Created by Matt Charters on 13-03-06.
//
//
...
@implementation BIODayViewController
...
- (void)setDay:(BIODay *)day {
    if([day isEqual:_day]) return;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    if(self.day == nil) {
        ...
        return [[[BIOTrackCollection sharedInstance] tracksForDay:self.day] count];
    }
}
